...
public class ArrayAccessTranslator extends AbstractTranslator implements AccessTranslator {
    ...
    // this is hack for a[1]++ -> a.set(1, a.get(1)). Frontend generate fake expression for a.get(1).
    @NotNull
    private TranslationContext contextWithValueParameterAliasInArrayGetAccess(@NotNull JsExpression toSetTo) {
        ...
        assert lastArgument instanceof ExpressionValueArgument: "Last argument of array-like getter must be ExpressionValueArgument";
