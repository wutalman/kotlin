...
public final class PropertyTranslator extends AbstractTranslator {
    ...
    private JsFunction generateDefaultSetterFunction(@NotNull PropertySetterDescriptor setterDescriptor) {
        ...
        JsParameter defaultParameter = new JsParameter(context().getNameForDescriptor(valueParameterDescriptor));
        ...
        if (delegatedCall != null) {
            setExpression = ReferencePackage.buildCall(context(), delegatedCall, getDelegateNameRef(getPropertyName()));
        } else {
