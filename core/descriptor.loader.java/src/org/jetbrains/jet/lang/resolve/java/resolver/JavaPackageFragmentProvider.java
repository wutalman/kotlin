            ...
            if (kotlinClass != null) {
                ...
                if (kotlinPackageScope != null) {
                    return new JavaFullPackageScope(packageFragment, kotlinPackageScope,
                                                    new JavaPurePackageScope(packageFragment, javaPackage, fqName, memberResolver, false));
                }
            }
