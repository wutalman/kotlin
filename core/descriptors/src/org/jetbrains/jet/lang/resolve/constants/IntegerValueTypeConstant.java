...
public class IntegerValueTypeConstant extends CompileTimeConstant<Number> {
    ...
    public IntegerValueTypeConstant(Number value) {
        super(value);
        typeConstructor = new IntegerValueTypeConstructor(value.longValue());
    }
    ...
    public JetType getType(@NotNull KotlinBuiltIns kotlinBuiltIns) {
        return new JetTypeImpl(
                Collections.<AnnotationDescriptor>emptyList(), typeConstructor,
