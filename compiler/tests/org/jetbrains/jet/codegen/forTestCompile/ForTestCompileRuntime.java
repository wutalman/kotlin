...
public class ForTestCompileRuntime {
    ...
    public static void compileBuiltIns(@NotNull File destDir) throws IOException {
        String src = "core/builtins/src" + File.pathSeparator + "core/runtime.jvm/src";

        compileKotlinToJvm("built-ins", destDir, src, src);

        JetTestUtils.compileJavaFiles(
                ContainerUtil.concat(javaFilesUnder("core/builtins/src"), javaFilesUnder("core/runtime.jvm/src")),
                Arrays.asList(
