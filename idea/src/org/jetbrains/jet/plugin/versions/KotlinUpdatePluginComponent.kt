...
class KotlinUpdatePluginComponent : ApplicationComponent {
    override fun initComponent() {
        val oldVersion = PropertiesComponent.getInstance()?.getValue("plugin.version")

        if (oldVersion == null || JetPluginUtil.getPluginVersion() != oldVersion) {
            ...
            PropertiesComponent.getInstance()?.setValue("plugin.version", JetPluginUtil.getPluginVersion())
